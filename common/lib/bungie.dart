...
class BungieClient {
  ...
  getBungieAccount(String id) async {
    final url =
        'http://www.bungie.net/Platform/User/GetBungieAccount/${id}/254/';
    return _getJson(url);
  }
  ...
  getDestinyAccount(String id, bool onXbox) async {
    ...
    final url =
        'http://www.bungie.net/Platform/User/GetBungieAccount/${id}/${type}/';
    return _getJson(url);
  }
  ...
  getClan(String id, bool onXbox, int pageIndex) async {
    final type = onXbox ? '1' : '2';
    final url =
        'http://www.bungie.net/Platform/Group/${id}/Members/?lc=en&fmt=true&currentPage=${pageIndex}&platformType=${type}';
    return _getJson(url);
  }
  ...
  Future<String> getDestinyId(String platformId, bool onXbox) async {
    ...
    final url =
        'http://www.bungie.net/Platform/Destiny/SearchDestinyPlayer/${type}/${platformId}';
  ...
  Future<String> getBungieId(String destinyId, bool onXbox) async {
    final type = onXbox ? '1' : '2';
    final url =
        'http://www.bungie.net/Platform/User/GetBungieAccount/${destinyId}/${type}/';
    var data = await _getJson(url);
